...
public class SpaceShip : MonoBehaviour
{
         ...
         if (other.gameObject.tag == "Player")
            {
                ...
                moveButton.transform.Rotate(0f,0f,90f);
                moveButton.transform.position = new Vector3 (217f, 268f, 0f);
    ...
    {   
        if (moveTheShip == true)
        {
            ShipRb.velocity = new Vector2(7, 0);

            moveInput = SimpleInput.GetAxis("Horizontal");

            ShipRb.velocity = new Vector2 (ShipRb.velocity.x, moveInput * speed);
